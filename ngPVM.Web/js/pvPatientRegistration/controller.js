...
currentApp.controller('pvPatientSearchController',
  function pvLoginController($scope, $log, $route, pvResources, pvDataService) {
    ...
    $scope.medPodVersionInformation = pvDataService.getMedPodVersionInformation();

    $scope.currentPatientList = {};

    $scope.currentPatientList.practice = "TEST";
    $scope.currentPatientList.clinic = "TEST";
    
    var currentDate = moment();
    $scope.currentPatientList.serviceDate = currentDate.format("MM/DD/YYYY");

    $scope.medPodCurrentPatients = pvDataService.getMedPodCurrentPatientsForCurrentDate($scope.currentPatientList.practice, $scope.currentPatientList.clinic);
    ...
    $scope.getCurrentPatients = function() {
      $scope.medPodCurrentPatients = pvDataService.getMedPodCurrentPatientsForServiceDate($scope.currentPatientList.practice, $scope.currentPatientList.clinic, $scope.currentPatientList.serviceDate);
      var currentDate = moment();
      $scope.currentPatientList.lastOperationTime = currentDate.format("dddd, MMMM Do YYYY, h:mm:ss a Z");
    };
...
currentApp.controller('pvPatientRegistrationController',
  function pvLoginController($scope, $log, $route, pvResources, pvDataService) {
    $log.info($route.current.controller + " executing.");
